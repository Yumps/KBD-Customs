    ...
    return (
      <div>
        ...
        <Jumbotron>
          ...
          <p className="lead">A React app to help provide easier resources and a keyboard builder to help manage your browser tabs.</p>
          <hr className="my-3"/>
          <p>
            ...
            hopefully help clear up some information and make it easier to find
            the answers you need; as well as provide a builder, so that the user
